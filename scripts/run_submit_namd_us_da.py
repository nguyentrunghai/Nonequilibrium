...
from _namd_us import write_tcl_us_da, write_namd_conf_us_da
...
parser.add_argument( "--initial_pdb",     type=str, default="smd_ini.pdb")
...
parser.add_argument( "--namd_output_name",     type=str, default="da")
...
for window_id in range(job_begin, job_end):
    ...
    write_tcl_us_da(tcl_force_file, window_center, force_constant=args.force_constant,
    ...
    write_namd_conf_us_da(namd_conf_file,
                          args.initial_pdb, args.structure_file, args.parm_file,
    ...
    qsub_script = os.path.join(out_dir, "da_us.job")
